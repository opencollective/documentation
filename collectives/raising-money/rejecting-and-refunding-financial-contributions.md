...
You can choose to reject and refund any contribution, refund a contribution without rejecting it, and even block contributions from selected accounts or groups.
...
### Refunding financial contributions

Not every refund means you need to reject the contributor. Use **Refund** when you want to return the payment but keep the contributor’s relationship with your Collective—for example, after a mistaken or duplicate donation, or when you agree to return money while they remain a supporter.

**Refund** returns the payment and updates your budget. It does **not** by itself cancel a recurring contribution, remove someone from your sponsor list, or block future donations.

**Reject** (below) refunds the payment **and** cancels any linked recurring contribution, removes their membership from your Collective, and is the right choice when you do not want that person or group associated with your Collective.

{% hint style="info" %}
If enabled by the Fiscal Host, Collective admins can refund financial contributions for up to 30 days after they are made. Fiscal Host admins can refund contributions indefinitely. For [manual bank transfers](../../giving-to-collectives/payment-methods.md), [added funds](../../fiscal-hosts/receiving-money/adding-funds-manually.md), and other off-platform payments, only Fiscal Host admins can process refunds—contact your Fiscal Host. See [Processing Refunds](../../fiscal-hosts/processing-refunds.md) for how hosts handle those cases. We recommend Fiscal Hosts have their own refund policy; learn more in [Fiscal Host Policies](../../fiscal-hosts/setting-up-a-fiscal-host/fiscal-host-policies.md).
{% endhint %}
...
For contributions paid through **Stripe** or **PayPal**, the platform returns funds through the original payment method after you confirm.

When you confirm the refund, you can optionally:

* Cancel any linked recurring contribution
* Remove the contributor from your Collective's sponsor list
* Send the contributor a message explaining the refund

Leave those options unchecked if you only want to return the payment and keep their membership as-is.
...
If you only need to return the payment and want to keep the contributor as a member or sponsor, use **Refund** instead (see above).
