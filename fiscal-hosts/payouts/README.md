...
TransferWise is still in beta release, so the first thing is to request access to the feature through [support@opencollective.com](mailto:support@opencollective.com).
