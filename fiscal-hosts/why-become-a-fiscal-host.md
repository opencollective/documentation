...
{% hint style="info" %}
A Fiscal Host is set up to manage multiple Collectives. These capabilities are reflected in the tools we have built for Fiscal Host management. If you want to manage a single account with your own bank account, we advise [converting to an Organization](../organizations/creating-an-organization/README.md#converting-between-collectives-and-organizations). This will provide a more streamlined experience.&#x20;
{% endhint %}
